          	...
          	<div class="panel panel-default">
          		<div class="panel-heading">
  			    		...
  			    		<form id="form">
  			    			...
  			    			<div class="form-group">
  			    				<input type="url" name="url" id="url" class="form-control input-sm form_input" placeholder="URL" value="https://api.coinmarketcap.com/v1/ticker/?convert=EUR&limit=10/">
  			    			</div>
                  ...
                  <div class="select_group">
                      ...
                      <div class="form-group">
                        <label for="cookie_list">Select COOKIES:</label>
                        <select id="cookie_list" multiple="multiple">
                        </select>
                      </div>

                      <div class="form-group">
                        <label for="cookie_list">Select SESSION:</label>
                        <select id="session_list" multiple="multiple">
                        </select>
                      </div>
